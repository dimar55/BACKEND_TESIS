...
exports.create = async (req, res) => {
    ...
    const response = await pool.query(`INSERT INTO lote (precio_entrada, precio_venta, cantidad_lote, fecha_vencimiento, cedula_pro, cedula_usu) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id_lote`, [precio_entrada, precio_venta, cantidad_lote, fecha_vencimiento, cedula_pro, cedula_usu]);
    res.status(201).json({
        success: true,
        message: 'Created',
        body: {
